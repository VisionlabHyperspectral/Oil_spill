...
load sample3_spec_dataset_Visible

%% Considering only 5 bands

[~,b]=intersect(lambda,lambda_true);
Abs_spectrum_sample3 = Abs_spectrum_sample3(b); 
...
sample3_0p5mm = sample3_0p5mm(b);
sample3_1p0mm = sample3_1p0mm(b);
sample3_1p5mm = sample3_1p5mm(b);
sample3_2p0mm = sample3_2p0mm(b);
sample3_2p5mm = sample3_2p5mm(b);
sample3_3p0mm = sample3_3p0mm(b);
sample3_3p5mm = sample3_3p5mm(b);
sample3_4p0mm = sample3_4p0mm(b);
sample3_4p5mm = sample3_4p5mm(b);
sample3_5p0mm = sample3_5p0mm(b);
