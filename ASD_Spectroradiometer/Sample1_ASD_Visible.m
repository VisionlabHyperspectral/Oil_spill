...
load sample1_spec_dataset_Visible

%% Considering only 5 bands

[~,b]=intersect(lambda,lambda_true);
Abs_spectrum_sample1 = Abs_spectrum_sample1(b); 
...
sample1_0p5mm = sample1_0p5mm(b);
sample1_1p0mm = sample1_1p0mm(b);
sample1_1p5mm = sample1_1p5mm(b);
sample1_2p0mm = sample1_2p0mm(b);
sample1_2p5mm = sample1_2p5mm(b);
sample1_3p0mm = sample1_3p0mm(b);
sample1_3p5mm = sample1_3p5mm(b);
sample1_4p0mm = sample1_4p0mm(b);
sample1_4p5mm = sample1_4p5mm(b);
sample1_5p0mm = sample1_5p0mm(b);
