...
[sample3_0p5mm_thick,~]...
    ...
    lambda_camera1,sample3_0p5mm,Spectral_response_camera1,incidence_angle,reflection_angle);


[sample3_1p0mm_thick,~]...
    = invert_spectra_oil_with_spectral_response(Abs_spectrum_sample3,background_1p0mm,...
    lambda_camera1,sample3_1p0mm,Spectral_response_camera1,incidence_angle,reflection_angle);

[sample3_1p5mm_thick,~]...
    = invert_spectra_oil_with_spectral_response(Abs_spectrum_sample3,background_1p5mm,...
    lambda_camera1,sample3_1p5mm,Spectral_response_camera1,incidence_angle,reflection_angle);

[sample3_2p0mm_thick,~]...
    = invert_spectra_oil_with_spectral_response(Abs_spectrum_sample3,background_2p0mm,...
    lambda_camera1,sample3_2p0mm,Spectral_response_camera1,incidence_angle,reflection_angle);

[sample3_2p5mm_thick,~]...
    = invert_spectra_oil_with_spectral_response(Abs_spectrum_sample3,background_2p5mm,...
    lambda_camera1,sample3_2p5mm,Spectral_response_camera1,incidence_angle,reflection_angle);

[sample3_3p0mm_thick,~]...
    = invert_spectra_oil_with_spectral_response(Abs_spectrum_sample3,background_3p0mm,...
    lambda_camera1,sample3_3p0mm,Spectral_response_camera1,incidence_angle,reflection_angle);

[sample3_3p5mm_thick,~]...
    = invert_spectra_oil_with_spectral_response(Abs_spectrum_sample3,background_3p5mm,...
    lambda_camera1,sample3_3p5mm,Spectral_response_camera1,incidence_angle,reflection_angle);

[sample3_4p0mm_thick,~]...
    = invert_spectra_oil_with_spectral_response(Abs_spectrum_sample3,background_4p0mm,...
    lambda_camera1,sample3_4p0mm,Spectral_response_camera1,incidence_angle,reflection_angle);

[sample3_4p5mm_thick,~]...
    = invert_spectra_oil_with_spectral_response(Abs_spectrum_sample3,background_4p5mm,...
    lambda_camera1,sample3_4p5mm,Spectral_response_camera1,incidence_angle,reflection_angle);

[sample3_5p0mm_thick,~]...
    = invert_spectra_oil_with_spectral_response(Abs_spectrum_sample3,background_5p0mm,...
    lambda_camera1,sample3_5p0mm,Spectral_response_camera1,incidence_angle,reflection_angle);
